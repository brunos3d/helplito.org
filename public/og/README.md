...
| --- | --- | --- | --- |
| `help-lito-og-1200x630.jpg` | 1200x630 | 1.91:1 | `og:image`. Facebook, LinkedIn, WhatsApp, Slack, Discord, iMessage and other Open Graph consumers. |
...
The copy in the cards is fixed English by design and is not localized.

```
pnpm dev     # terminal 1
pnpm og      # terminal 2, captures both files into public/og/
```
